...
public class OperadoresRelacionais {
	...
	public static void main(String[] args) {
		...
		Boolean  doisDiferenteADois = 2 != 2; 
		System.out.println("2 != 2? " + doisDiferenteADois);
		...
		System.out.println("centoVinteOito.equals(centoVinteOito02)? " + centoVinteOitoIgualCentoVinteOito02);
